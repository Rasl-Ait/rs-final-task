...
class TabBarViewProtocolMock: TabBarViewProtocol {
    init() { }
    init(onListsFlowSelect: ItemClosure<NavigationController>? = nil, onViewDidLoad: ItemClosure<NavigationController>? = nil, onSearchFlowSelect: ItemClosure<NavigationController>? = nil, onFavoriteFlowSelect: ItemClosure<NavigationController>? = nil) {
        self.onListsFlowSelect = onListsFlowSelect
        self.onViewDidLoad = onViewDidLoad
        self.onSearchFlowSelect = onSearchFlowSelect
        self.onFavoriteFlowSelect = onFavoriteFlowSelect
    }


    private(set) var onListsFlowSelectSetCallCount = 0
    var onListsFlowSelect: ItemClosure<NavigationController>? = nil { didSet { onListsFlowSelectSetCallCount += 1 } }

    private(set) var onViewDidLoadSetCallCount = 0
    var onViewDidLoad: ItemClosure<NavigationController>? = nil { didSet { onViewDidLoadSetCallCount += 1 } }

    private(set) var onSearchFlowSelectSetCallCount = 0
    var onSearchFlowSelect: ItemClosure<NavigationController>? = nil { didSet { onSearchFlowSelectSetCallCount += 1 } }

    private(set) var onFavoriteFlowSelectSetCallCount = 0
    var onFavoriteFlowSelect: ItemClosure<NavigationController>? = nil { didSet { onFavoriteFlowSelectSetCallCount += 1 } }
}
...
class CoordinatorFactoryMock: CoordinatorFactory {
    ...
    var makeAuthCoordinatorHandler: ((Router) -> (AuthCoordinator & AuthCoordinatorProtocol))?
    ...
    var makeListsCoordinatorHandler: ((Router) -> (ListsCoordinator & ListsCoordinatorProtocol))?
    ...
    var makeListDetailCoordinatorHandler: ((Router, ListModel) -> (ListDetailCoordinator & ListDetailCoordinatorProtocol))?
    ...
    var makeMovieDetailCoordinatorHandler: ((Router, Int) -> (MovieDetailCoordinator & MovieDetailCoordinatorProtocol))?
    ...
    var makeSearchCoordinatorHandler: ((NavigationController) -> (SearchCoordinator & SearchCoordinatorProtocol))?
    ...
    var makeFavoriteCoordinatorHandler: ((NavigationController) -> (FavoriteCoordinator & FavoriteCoordinatorProtocol))?
